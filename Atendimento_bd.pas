...
procedure TAtendimento.Att_Status;
 begin
  ...
  DM_CONEXAO.Qry_Usuarios.SQL.Add('UPDATE USUARIOS SET DISPONIBILIDADE =');
  DM_CONEXAO.Qry_Usuarios.SQL.Add(''''+Meu_Status+'''');
  DM_CONEXAO.Qry_Usuarios.SQL.Add('WHERE NOME_PC =');
  DM_CONEXAO.Qry_Usuarios.SQL.Add(''''+Nome_Pc+'''');
